...
module.exports = (grunt) => {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/astra-pagealbum/plugin.js': [
            'src/text/license-header.js',
            scratchPluginPath
          ],
          'dist/astra-pagealbum/plugin.min.js': [
            'src/text/license-header.js',
    ...
    copy: {
      css: {
        files: [
          { src: [ 'CHANGELOG.txt', 'LICENSE.txt' ], dest: 'dist/astra-pagealbum', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', () => {
    grunt.file.write('dist/astra-pagealbum/version.txt', BUILD_VERSION);
  });
